...
\date{2\textsuperscript{nd} June 2026}
...
\cellcolor{red}\color{white} Required\phantom{:} & \cellcolor{red}\phantom{:} \\
...
\multicolumn{2}{l}{\textcolor{magenta}{\tt -{}-{}- PDFTOSVG\_CONVERTER is set to `mutool' -{}-{}-}} \\
