...
BOOKML_MK    := bookml/bookml.mk bookml/deps.pl bookml/latexmk.rc bookml/manifest.pl bookml/postpdf.pl bookml/postxml.pl bookml/search_index.pl bookml/xsltproc.pl
