...
\bmlRawHTML{
  ...
  <script async="" src="https://www.googletagmanager.com/gtag/js?id=G-CYGVWQVMS4"></script>
  <script>
      window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-CYGVWQVMS4');
  </script>
}
...
\begin{center}
  ...
  \lxWithClass{noepub}{\bmlRawHTML{
    <br/>
    <img src="https://img.shields.io/github/v/release/vlmantova/bookml?logo=github\&amp;display\_name=release"/>
    <img src="https://img.shields.io/github/downloads/vlmantova/bookml/total?logo=github" class="noepub"/>
    <img src="https://img.shields.io/github/stars/vlmantova/bookml?logo=github"/>
  }}
